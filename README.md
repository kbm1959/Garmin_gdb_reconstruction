...
This is a Python App which reconstructs a Garmin basecamp backup to a local directory structure and extracts Tracks and Waypoints from the database to this local structure.
